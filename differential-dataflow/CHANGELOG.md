...
## [0.18.0](https://github.com/lukeswissman/differential-dataflow/compare/differential-dataflow-v0.17.0...differential-dataflow-v0.18.0) - 2025-10-20

### Other

- Update columnar; introduce mimalloc
- Extract `VecCollection` from `Collection` ([#651](https://github.com/lukeswissman/differential-dataflow/pull/651))
- Introduce traits for collection containers ([#650](https://github.com/lukeswissman/differential-dataflow/pull/650))
- Correct some clippy nit ([#649](https://github.com/lukeswissman/differential-dataflow/pull/649))
- Batcher implementation that has no opinions about chains, and columnar. ([#626](https://github.com/lukeswissman/differential-dataflow/pull/626))
